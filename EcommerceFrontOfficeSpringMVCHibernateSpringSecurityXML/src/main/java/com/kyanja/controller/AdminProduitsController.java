...
public class AdminProduitsController {
	...
	@Autowired
	private IAdminProduitService metier;
	...
	public String edit(@RequestParam("idProd") Long idProd,Model model){
	Produit p=metier.getProduit(idProd);
	model.addAttribute("produit",p);
	model.addAttribute("produits",metier.listproduits());
//	model.addAttribute("categories", metier.listCategories());
	model.addAttribute("categories", metier.listDToCategories());
	return "produits";
	}
